...
class WalletIdTransactionServiceTest {
    ...
    void givenUserWalletTransactionEntity_whenSaveAndRetrieve_thenMatch() {
        ...
        Page<UserWalletTransaction> transactionList = userWalletTransactionService.getTransactionsByWalletId(BigInteger.ONE,1, 0);
        Mockito.when(userWalletTransactionService.getTransactionsByWalletId(BigInteger.ONE,1, 0)).thenReturn(tempList);
